  ...
  return (
    ...
    >
      <div className={isCards ? "mb-2" : "mb-3"}>
        <h3 className="text-[0.68rem] font-semibold uppercase tracking-[0.16em] text-[#E8D25A]">
          {title}
        </h3>
        {subtitle && (
          ...
          <button
            ...
            className={
              isCards
                ...
                : "max-w-full rounded-full border border-worknoon-ice/15 bg-worknoon-ice/[0.05] px-3 py-1.5 text-left text-xs font-medium text-worknoon-ice/75 transition hover:border-worknoon-ice/35 hover:bg-worknoon-ice/[0.085] disabled:cursor-not-allowed disabled:opacity-50"
            }
          >
            <span
              className={
                isCards
                  ? "block truncate text-xs font-semibold text-[#E8D25A]"
                  : "block truncate whitespace-nowrap text-[#E8D25A]"
              }
            >
              {suggestion.label}
            </span>
            {isCards && suggestion.description && (
              <span className="mt-0.5 block truncate text-[0.68rem] leading-relaxed text-[#E8D25A]">
